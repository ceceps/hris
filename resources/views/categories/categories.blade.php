...
<div class="col-sm-12" style="display:none;" id="form_tambah">
    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <form id="formJob" enctype="application/x-www-form-urlencoded">
                @csrf
                <div class="form-group row">
                    <input type="hidden" name="id" id="id">
                    <label class="col-sm-2 col-form-label">Nama Kategori <span>*</span></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                            name="name" id="name"  placeholder="Isi Nama Kategori" maxlength="100">
...
<div class="col-sm-12">
    ...
    <div class="card">
        <div class="card-block">
            ...
            <input type="button" class="btn btn-success" id="show_form_category" value="TAMBAH">
        </div>
    </div>
</div>
    ...
    <div class="card">
        ...
        <div class="card-block">
            <div class="dt-responsive table-responsive">
                <table id="tableCategory" class="table table-striped table-bordered nowrap" style="width:100%;">
                    <thead>
                        <tr>
                            <th>Detail</th>
                            <th>Check</th>
...
@endsection
@section('pagescript')
@include('categories.scriptcategories')
@endsection
