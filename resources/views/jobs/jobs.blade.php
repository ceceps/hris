        ...
        <div class="card-block">
            ...
            <form id="formJob" enctype="application/x-www-form-urlencoded">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label">Nama Pekerjaan <span>*</span></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                            name="name" id="name"  placeholder="Nama Pekerjaan" maxlength="100">
    ...
    <div class="card">
        ...
        <div class="card-block">
            <div class="dt-responsive table-responsive">
                <table id="tableJob" class="table table-striped table-bordered nowrap" style="width:100%;">
                    <thead>
                        <tr>
                            <th>Detail</th>
                            <th>Check</th>
